...
function traiterCall(monObj) {
   ...
   return(
		...
		+"<tr>"
		+"<td></td>"
		+"<td></td>"+"<td align='right'>+----&gt;</td>"+"<td>"+((monObj.cible!=undefined && monObj.cible!=null && monObj.cible!='')? monObj.cible : "void")+"</td>"
		+"</tr>"
		);
}
function traiterLd(monObj) {
	        var lsStr = "<tr><td><a name='"+monObj.label+"'>"+monObj.label+"</a></td><td>"+monObj.inst+"</td><td>VariableName "+monObj.variable+" VariableVersion "+monObj.version+" VariableCode "+monObj.valeur+"</td><td>"+"</td></tr>";
		return (lsStr);
}
function traiter(monObj) {
	...
	default : 
	        var lsStr = "<tr><td><a name='"+monObj.label+"'>"+monObj.label+"</a></td><td>"+monObj.inst+"</td><td>"+((monObj.detail!=null && monObj.detail!=undefined) ? monObj.detail : "")+"</td><td></td></tr>";
		return (lsStr);
	}
}
...
function chargerTheDivClasse(avClasse) {
   ...
   for (var liIndi=0; liIndi<maData.methodes.length; liIndi++) {
      ...
      if (avClasse == lvMethode.classe && maMethode==lvMethode.methode) {
         lsStr += "<br />";
         lsStr += "<table border='1'>";
         ...
         lsStr +=           "</table></td></tr>";
         if (lvMethode.locals!=undefined && lvMethode.locals!=null){
         ...
         lsStr += "<tr><td><table border=\"1\">";
         if (lvMethode.corps!=undefined && lvMethode.corps!=null){
...
function traiterClasseDetail(liIndi, lvClasse, lvListeInst, abTout) {
   ...
   var Dataflowedges   = [];
      ...
      for (var liInd=0; liInd<lvListeInst.length; liInd++) {
         ...
         if (lvInst.args!=undefined && lvInst.args!=null) {
            ...
            if (lvInst.args!=undefined && lvInst.args!=null &&0<lvInst.args.length) {
...
function getCalculerClasse(liIndi, lvMeth) {
   var lsRes = "";
   if (lvMeth.listeDeListeLabel!=undefined && lvMeth.listeDeListeLabel!=null) {
